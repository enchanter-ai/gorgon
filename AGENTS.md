...
- **doubt-engine.md** — `../vis/packages/core/conduct/doubt-engine.md` — adversarial self-check before agreement; active counter to F01 sycophancy
...
- **tier-sizing.md** — `../vis/packages/core/conduct/tier-sizing.md` — Opus intent-level, Sonnet decomposed, Haiku senior-to-junior
- **web-fetch.md** — `../vis/packages/web/conduct/web-fetch.md` — WebFetch is Haiku-tier-only; cache and budget
- **inference-substrate.md** — `shared/conduct/inference-substrate.md` — emit-only contract for the Wixie inference engine
